...
function TestimonialsSection() {
  return (
    <div className='pb-14 px-8 md:px-0'>
      ...
      <p className='md:text-base text-gray-500 mt-3'>Hear from lerners as they share their journeys of transformation, success, and how our <br /> platform has made a difference in their lives.</p>
