    ...
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        {/* review and rating */}
                ...
                <p className='text-sm'>Course by <span className='text-blue-600 underline'>Sonu</span></p>
        ...
        {/* right Column */}
        <div className='max-width z-10 box-shadow rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
          
        {
          ...
          <div className='p-5'>
            ...
            <img className='w-3.5' src={assets.time_left_clock_icon} alt="itime left      clock icon" /> 
            ...
            <div className='pt-6'>
                  ...
                  <ul className='ml-4 pt-2 test-sm md:text-default list-disc text-gray-500'>
